  ...
  client.on("message", message => {
   ...
   client.on("message", message => {
    if (message.content === "$invite") {
     const embed = new Discord.RichEmbed()
         .setColor("RANDOM")
         .addField('Broadcast', `https://discordapp.com/api/oauth2/authorize?client_id=510740006151651338&permissions=8&scope=bot`)
   ...
   client.on("message", message => {
    if (message.content === "$support") {
     const embed = new Discord.RichEmbed()
         .setColor("RANDOM")
         .addField('❤سيرفر الدعم الفني', `  https://discord.gg/AWECFnq  `)
     message.author.send({embed});
